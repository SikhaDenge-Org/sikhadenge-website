...
import { getCanaryAuthorizationContext } from "../../lib/admin/canary-authorization-context";
    ...
    >
      <div className="admin-enterprise-root">
        <section className="suite-card" aria-labelledby="canary-authorization-context-title">
          ...
          <footer>
            <small>
              Read-only context only. It does not change outbound mode, approvals, or provider state.
            </small>
          </footer>
        </section>
        <AdminManager />

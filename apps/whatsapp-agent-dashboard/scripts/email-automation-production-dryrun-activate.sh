...
printf 'SEQUENCE=provision,preflight,reconcile-scheduler,activate,first-run,verify\nEXTERNAL_WRITES=false\nRUNTIME_MODE=DRY_RUN\n'
...
# Activation is deliberately idempotent: remove any disabled/stale unit files before
# writing the reviewed scheduler units. This repairs a partially restored scheduler
# without widening Email runtime mode or external-write policy.

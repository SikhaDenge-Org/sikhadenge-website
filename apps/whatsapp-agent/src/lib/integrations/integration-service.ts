...
const PROVIDERS: Array<{
  ...
  },
  {
    ...
    description: "Multi-sender email connection, templates, inbound threads and automation foundation.",
    secretEnvironment: ["GOOGLE_EMAIL_CLIENT_ID", "GOOGLE_EMAIL_CLIENT_SECRET"],
